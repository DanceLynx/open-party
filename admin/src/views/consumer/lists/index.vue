    ...
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <el-table size="large" v-loading="pager.loading" :data="pager.lists">
                ...
                <el-table-column label="党费" prop="party_fee" min-width="120" />
                <el-table-column label="党组织" prop="department_text" min-width="120" />
                <el-table-column label="党内职务" prop="member_level_text" min-width="120" />
